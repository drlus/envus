...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_pendulum_dae_cffi(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_pendulum_dae_cffi(void) { return NULL; }
#  else
     initpendulum_dae_cffi(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit_pendulum_dae_cffi(void)
{
  return _cffi_init("pendulum_dae_cffi", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initpendulum_dae_cffi(void)
{
  _cffi_init("pendulum_dae_cffi", 0x2601, &_cffi_type_context);
}
#endif
