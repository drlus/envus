...
class model: 
    ...
    def __init__(self): 
        ...
        self.inputs_ini_list = ['tau', 'u_dummy'] 
        self.inputs_ini_values_list  = [0.0, 1.0] 
        self.inputs_run_list = ['tau', 'u_dummy'] 
        self.inputs_run_values_list = [0.0, 1.0] 
        self.outputs_list = ['x_pos', 'y_pos', 'tau'] 
        ...
        if self.dae_file_mode == 'enviroment':
            ...
            self.sp_jac_run = sspa.load_npz('./__pycache__/pendulum_dae_sp_jac_run_num.npz')
        ...
        if self.dae_file_mode == 'enviroment':
            ...
            self.sp_jac_trap = sspa.load_npz('./__pycache__/pendulum_dae_sp_jac_trap_num.npz')
